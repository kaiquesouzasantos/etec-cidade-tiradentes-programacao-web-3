...
document.getElementById('curriculo').addEventListener('mouseover', () => {
  elementos.forEach(
    (elemento) => 
      setValue(elemento, getValue(elemento))
  )

  setValue('text_inicio', formatDate(getValue('text_inicio'))+' ate '+formatDate(getValue('text_termino')))
  ...
  setValue('text_instituicao_curso', 
    getValue('text_instituicao_curso')+ ' - ('+formatDate(getValue('text_inicio_curso'))+' ate '+formatDate(getValue('text_termino_curso'))+')<br>'+
    getValue('text_descricao_curso')+' | '+getValue('text_descricao_curso')
  )
  setValue('text_curso_c', 
    getValue('text_instituicao_curso_c')+' - ('+formatDate(getValue('text_inicio_curso_c'))+' ate '+formatDate(getValue('text_termino_curso_c'))+')' +
