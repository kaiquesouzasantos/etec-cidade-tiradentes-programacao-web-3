...
function setValues() {
  ...
  setValue('text_instituicao_curso', 
    getValue('text_instituicao_curso')+ ' - ('+formatDate(getValue('text_inicio_curso'))+' ate '+
  ...
  setValue('text_curso_c', 
    getValue('text_instituicao_curso_c')+' - ('+formatDate(getValue('text_inicio_curso_c'))+' ate '+
